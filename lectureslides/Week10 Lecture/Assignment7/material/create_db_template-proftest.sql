...
-- create the tables
CREATE TABLE proftest.categories (
  categoryID       INT(11)        NOT NULL   AUTO_INCREMENT,
  categoryName     VARCHAR(255)   NOT NULL,
  PRIMARY KEY (categoryID)
);

CREATE TABLE proftest.products (
...
INSERT INTO proftest.categories VALUES
(1, 'Guitars'),
(2, 'Basses'),
(3, 'Drums');

INSERT INTO proftest.products VALUES
...
CREATE TABLE proftest.customers_admin (
...
CREATE TABLE proftest.addresses_admin (
...
CREATE TABLE proftest.orders_admin (
...
CREATE TABLE proftest.orderItems_admin (
...
CREATE TABLE proftest.products_admin (
...
CREATE TABLE proftest.categories_admin (
  categoryID        INT            NOT NULL   AUTO_INCREMENT,
  categoryName      VARCHAR(255)   NOT NULL,
  PRIMARY KEY (categoryID)
);

CREATE TABLE proftest.administrators (
...
INSERT INTO proftest.categories_admin (categoryID, categoryName) VALUES
(1, 'Guitars'),
(2, 'Basses'),
(3, 'Drums');

INSERT INTO proftest.products_admin (productID, categoryID, productCode, productName, description, listPrice, discountPercent, dateAdded) VALUES
...
INSERT INTO proftest.customers_admin (customerID, emailAddress, password, firstName, lastName, shipAddressID, billingAddressID) VALUES
...
INSERT INTO proftest.addresses_admin (addressID, customerID, line1, line2, city, state, zipCode, phone, disabled) VALUES
...
INSERT INTO proftest.orders_admin (orderID, customerID, orderDate, shipAmount, taxAmount, shipDate, shipAddressID, cardType, cardNumber, cardExpires, billingAddressID) VALUES
...
INSERT INTO proftest.orderItems_admin (itemID, orderID, productID, itemPrice, discountAmount, quantity) VALUES
(1, 1, 2, '399.00', '39.90', 1),
(2, 2, 4, '699.00', '69.90', 1),
(3, 3, 3, '499.00', '49.90', 1),
(4, 3, 6, '549.99', '0.00', 1);

INSERT INTO proftest.administrators (adminID, emailAddress, password, firstName, lastName) VALUES
