-- Create the testam0000 database
-- DROP DATABASE IF EXISTS xxx_my_guitar_shop1;
CREATE DATABASE xxx_my_guitar_shop1;

-- create the tables
CREATE TABLE xxx_my_guitar_shop1.categories (
  categoryID       INT(11)        NOT NULL   AUTO_INCREMENT,
  categoryName     VARCHAR(255)   NOT NULL,
  PRIMARY KEY (categoryID)
);

CREATE TABLE xxx_my_guitar_shop1.products (
...
CREATE TABLE xxx_my_guitar_shop1.orders (
...
INSERT INTO xxx_my_guitar_shop1.categories VALUES
(1, 'Guitars'),
(2, 'Basses'),
(3, 'Drums');

INSERT INTO xxx_my_guitar_shop1.products VALUES
...
/*****************************************
* Create the testam0000_2 database
*****************************************/
-- DROP DATABASE IF EXISTS xxx_my_guitar_shop2;
CREATE DATABASE xxx_my_guitar_shop2;


-- create the tables for the database
CREATE TABLE xxx_my_guitar_shop2.customers (
...
CREATE TABLE xxx_my_guitar_shop2.addresses (
...
CREATE TABLE xxx_my_guitar_shop2.orders (
...
CREATE TABLE xxx_my_guitar_shop2.orderItems (
...
CREATE TABLE xxx_my_guitar_shop2.products (
...
CREATE TABLE xxx_my_guitar_shop2.categories (
  categoryID        INT            NOT NULL   AUTO_INCREMENT,
  categoryName      VARCHAR(255)   NOT NULL,
  PRIMARY KEY (categoryID)
);

CREATE TABLE xxx_my_guitar_shop2.administrators (
...
INSERT INTO xxx_my_guitar_shop2.categories (categoryID, categoryName) VALUES
(1, 'Guitars'),
(2, 'Basses'),
(3, 'Drums');

INSERT INTO xxx_my_guitar_shop2.products (productID, categoryID, productCode, productName, description, listPrice, discountPercent, dateAdded) VALUES
...
INSERT INTO xxx_my_guitar_shop2.customers (customerID, emailAddress, password, firstName, lastName, shipAddressID, billingAddressID) VALUES
...
INSERT INTO xxx_my_guitar_shop2.addresses (addressID, customerID, line1, line2, city, state, zipCode, phone, disabled) VALUES
...
INSERT INTO xxx_my_guitar_shop2.orders (orderID, customerID, orderDate, shipAmount, taxAmount, shipDate, shipAddressID, cardType, cardNumber, cardExpires, billingAddressID) VALUES
...
INSERT INTO xxx_my_guitar_shop2.orderItems (itemID, orderID, productID, itemPrice, discountAmount, quantity) VALUES
(1, 1, 2, '399.00', '39.90', 1),
(2, 2, 4, '699.00', '69.90', 1),
(3, 3, 3, '499.00', '49.90', 1),
(4, 3, 6, '549.99', '0.00', 1);

INSERT INTO xxx_my_guitar_shop2.administrators (adminID, emailAddress, password, firstName, lastName) VALUES
